...
var _getUsernameFromEmail = exports._getUsernameFromEmail = function getUsernameFromEmail(email) {
...
function forgotPassword(_ref) {
	var provider = _ref.provider,
	    ...
	    getUsernameFromEmail = _ref$getUsernameFromE === undefined ? _getUsernameFromEmail : _ref$getUsernameFromE;
	...
	return function forgotPassword(_ref2) {
		...
		return new Promise(function (resolve, reject) {
			...
			console.log(JSON.stringify({ email: email }, null, 4));
			...
			console.log(JSON.stringify({ messages: messages }, null, 4));
			if (messages.length) {
			...
			console.log(JSON.stringify({ username: username }, null, 4));
			...
			console.log(JSON.stringify({ params: params }, null, 4));
